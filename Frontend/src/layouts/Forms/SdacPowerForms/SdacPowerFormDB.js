...
export default function SdacPowerFormDB() {
  ...
  const SendFormData = (event) => {
    ...
    axios
      .post(`http://localhost:5000/TowingLogApi/sdacPower/update`, requestData)
      .then((response) => {
        setDataDB({
          ...dataDB,
          loading: false,
  ...
  const SendarchiveFormData = async (event) => {
    ...
    const archiverequestData = {
      ...
      darom_tank: archiveData.darom_tank,
      darom_namer: archiveData.darom_namer,
      darom_hashaz: archiveData.darom_hashaz,
      darom_ngmash: archiveData.darom_ngmash,
      darom_tomat: archiveData.darom_tomat,
      darom_zma: archiveData.darom_zma,
      darom_car: archiveData.darom_car,

      merkaz_tank: archiveData.merkaz_tank,
      merkaz_ngmash: archiveData.merkaz_ngmash,
      merkaz_zma: archiveData.merkaz_zma,
      merkaz_car: archiveData.merkaz_car,

      zafon_tank: archiveData.zafon_tank,
      zafon_namer: archiveData.zafon_namer,
      zafon_hashaz: archiveData.zafon_hashaz,
      zafon_ngmash: archiveData.zafon_ngmash,
      zafon_tomat: archiveData.zafon_tomat,
      zafon_zma: archiveData.zafon_zma,
      zafon_car: archiveData.zafon_car,
    };

    await axios
      .post(`http://localhost:5000/TowingLogApi/sdacPowerArchive/add`, archiverequestData)
      .then((response) => {
        console.log("response.data");
        console.log(response.data);
        setDataDB({
