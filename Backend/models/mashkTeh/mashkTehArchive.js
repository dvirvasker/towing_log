...
const mashkTehArchiveSchema = new mongoose.Schema(
  {
...
const MashkTehArchive = mongoose.model("mashkTehArchive", mashkTehArchiveSchema);

module.exports = MashkTehArchive;
